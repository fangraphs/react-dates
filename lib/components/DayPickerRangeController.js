...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  showOnlyBaseballMonths: _propTypes["default"].bool
}) : {};
var defaultProps = {
  startDate: undefined,
  // TODO: use null
...
function (_ref) {
  ...
  _proto.onPrevMonthClick = function onPrevMonthClick() {
    ...
    var prevMonthVisibleDays = (0, _getVisibleDays["default"])(prevMonth, incrementMonth, enableOutsideDays, true);
  ...
  _proto.onNextMonthClick = function onNextMonthClick() {
    ...
    var nextMonthVisibleDays = (0, _getVisibleDays["default"])(nextMonth, incrementMonth, enableOutsideDays, true);
